...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<BaseResponse<UserEntity>> getUserInfo() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<UserEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<UserEntity> _value;
    try {
      _value = BaseResponse<UserEntity>.fromJson(
        _result.data!,
  ...
  Future<BaseResponse<dynamic>> updateUser(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userUpdateRequest.toJson());
  ...
  @override
  Future<BaseResponse<dynamic>> deleteUser(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse<dynamic>> updateDevice(
    int id,
  ...
  @override
  Future<BaseResponse<List<DeviceDetail>>> getDeviceDetail(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<List<DeviceDetail>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<List<DeviceDetail>> _value;
    try {
      _value = BaseResponse<List<DeviceDetail>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<DeviceDetail>(
                    (i) => DeviceDetail.fromJson(i as Map<String, dynamic>))
                .toList()
            : List.empty(),
      );
    } on Object catch (e, s) {
  ...
  @override
  Future<BaseResponse<dynamic>> deleteUserDevice(
    int userId,
    int deviceId,
  ) async {
    final _extra = <String, dynamic>{};
